...
import hero from "../../work/shopify-apple-watch/hero.png"
import sketches from "../../work/shopify-apple-watch/sketches.jpg"
import gif from "../../work/shopify-apple-watch/shopify-watch.gif"
    ...
    <div>
      ...
      <Section>
        <TwoColumns>
          <Figure>
            ...
            <FigCaption title="Initial sketching">
              Pen and paper really force you to distill a problem to its essence.
            </FigCaption>
          </Figure>
          <div>
      ...
      <Section>
        <TwoColumns>
          <Figure>
            <img src={gif} alt="" />
            <FigCaption title="First Prototype">
              This is the first working prototype I was able to see in the Simulator. I was so happy.
            </FigCaption>
          </Figure>
          <div>
